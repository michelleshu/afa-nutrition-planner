...
export const VEGETABLE_SERVING = {
  calories: 25,
  carbGrams: 5,
  fatGrams: 0,
  proteinGrams: 2,
...
export const LEAN_PROTEIN_SERVING = {
  calories: 105,
  carbGrams: 0,
  fatGrams: 3,
  proteinGrams: 21,
